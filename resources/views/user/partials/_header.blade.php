            ...
            <div class="header-top-inner">
                <div class="cnt-account">
                    <ul class="list-unstyled">
                        <li><a href="#"><i
                                    class="icon fa fa-user"></i>{{ session()->get('language') == 'eng' ? 'My Account' : 'Mənim Hesabım' }}</a>
                        </li>
                    ...
                    <ul class="list-unstyled list-inline">
                        ...
                        {{-- <li class="dropdown dropdown-small"> <a href="#" class="dropdown-toggle" data-hover="dropdown"
                                data-toggle="dropdown"><span
                                    class="value">{{ session()->get('language') == 'eng' ? 'Language' : 'Dil' }}
                                </span><b class="caret"></b></a>
                            <ul class="dropdown-menu">
                                @if (session()->get('language') == 'aze')
                                    <li><a href="{{ route('aze.language') }}">Aze</a></li>
                                @else
                                    <li><a href="{{ route('eng.language') }}">Eng</a></li>
                                @endif
                            </ul>
                        </li> --}}
                    </ul>
